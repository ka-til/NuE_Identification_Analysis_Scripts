...
if DC:
    ...
    #name = 'upgrade_NMO_only_upgrade_relaxed_cut_no_pid_cut_12_10_no_mask_llh_'
    name = 'upgrade_NMO_only_upgrade_signal_region_random_0.05_8_6_no_mask_llh_'
...
if DC:
    ...
    p1_nu_NO = Pipeline("settings/pipeline/pipeline_upgrade_neutrinos_std_osc_NO%s_nue_random.cfg"%(old))
    free_params(p1_nu_NO)
    p1_nu_IO = Pipeline("settings/pipeline/pipeline_upgrade_neutrinos_std_osc_IO%s_nue_random.cfg"%(old))
