...
plt.savefig('/data/user/akatil/electron_neutrino/for_real/PISA/pseudo_experiments_nh_nh_upgrade_original.png', bbox_inches='tight')
plt.clf()
...
plt.savefig('/data/user/akatil/electron_neutrino/for_real/PISA/pseudo_experiments_nh_ih_upgrade_original.png', bbox_inches='tight')
plt.clf()
...
plt.savefig('/data/user/akatil/electron_neutrino/for_real/PISA/pseudo_experiments_ih_nh_upgrade_original.png', bbox_inches='tight')
plt.clf()
...
plt.savefig('/data/user/akatil/electron_neutrino/for_real/PISA/pseudo_experiments_ih_ih_upgrade_original.png', bbox_inches='tight')
plt.clf()
...
plt.savefig('/data/user/akatil/electron_neutrino/for_real/PISA/pseudo_experiments_sensitivity_upgrade_original.png', bbox_inches='tight')
plt.clf()
