...
p1_nu_NO = Pipeline("settings/pipeline/pipeline_upgrade_neutrinos_std_osc_NO_nue.cfg")
p1_nu_IO = Pipeline("settings/pipeline/pipeline_upgrade_neutrinos_std_osc_IO_nue.cfg")
...
for i in range(20):
    ...
    sens_true_NO.append(calc_sens(best_fit_info_ih_nh.metric_val, best_fit_info_nh_ih.metric_val))
...
plt.savefig('/data/user/akatil/electron_neutrino/for_real/PISA/pseudo_experiments_nh_nh_upgrade_nue.png', bbox_inches='tight')
plt.clf()
...
plt.savefig('/data/user/akatil/electron_neutrino/for_real/PISA/pseudo_experiments_nh_ih_upgrade_nue.png', bbox_inches='tight')
plt.clf()
...
plt.savefig('/data/user/akatil/electron_neutrino/for_real/PISA/pseudo_experiments_ih_nh_upgrade_nue.png', bbox_inches='tight')
plt.clf()
...
plt.savefig('/data/user/akatil/electron_neutrino/for_real/PISA/pseudo_experiments_ih_ih_upgrade_nue.png', bbox_inches='tight')
plt.clf()
...
plt.savefig('/data/user/akatil/electron_neutrino/for_real/PISA/pseudo_experiments_sensitivity_upgrade_nue.png', bbox_inches='tight')
plt.clf()
...
plt.ylabel('#pseudo experiments')
plt.savefig('/data/user/akatil/electron_neutrino/for_real/PISA/pseudo_experiments_del_chi2_upgrade_original.png', bbox_inches='tight')
plt.clf()
