...
if __name__ == '__main__':
    ...
    parser.add_argument("--outdir", type=str, default='/data/user/akatil/electron_neutrino/for_real/dataset_complete/NuE_BDT_stage/', help="Give the output directory where files should be located")
    ...
    filelist = sorted(glob(f'/data/user/akatil/electron_neutrino/for_real/dataset_complete/enriched_029_median_iqr_skew_kurtosis_beta/{dataset}/upgrade_genie_level4_queso_*.i3.zst'))
