...
script=/data/user/akatil/electron_neutrino/for_real/analysis_chain/step2_santa_reco.py
...
$i3env python $script --indir $OUTDIR --interaction $INTERACTION --dataset $DATASET --outdir $OUTDIR
