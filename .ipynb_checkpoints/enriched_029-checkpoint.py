...
def calculate_beta_angle(frame, geo):
    ...
    if beta1_reco >= 0 and beta1_reco <= 0.001 and median_angle >= 0.5 and median_angle <= 0.9 and pid <= 0.4:

        frame['Beta1'] = dataclasses.I3Double(beta1_reco)
        frame['median_angle'] = dataclasses.I3Double(median_angle)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--outdir", type=str, default='/data/user/akatil/electron_neutrino/for_real/dataset_complete/enriched_029/', help="Give the output directory where files should be located")
